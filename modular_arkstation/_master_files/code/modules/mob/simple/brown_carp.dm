/mob/living/basic/carp/brown
	...
	icon = 'modular_arkstation/_master_files/icons/mob/simple_mob/brown_carp.dmi'
...
/mob/living/basic/carp/brown/beret
	...
	icon = 'modular_arkstation/_master_files/icons/mob/simple_mob/brown_carp_beret.dmi'
