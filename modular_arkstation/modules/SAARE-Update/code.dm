/obj/item/clothing/under/rank/security/saare
	...
	desc = "<Placeholder>"
	icon = 'modular_arkstation/modules/SAARE-Update/icons/obj.dmi'
	worn_icon = 'modular_arkstation/modules/SAARE-Update/icons/mob.dmi'
	worn_icon_digi = 'modular_arkstation/modules/SAARE-Update/icons/saare_digi.dmi'
	lefthand_file = 'modular_arkstation/modules/SAARE-Update/icons/saare_left.dmi'
	righthand_file = 'modular_arkstation/modules/SAARE-Update/icons/obj.dmi'
	icon_state = "saare"
...
/obj/structure/sign/flag/saare
	name = "flag of SAARE"
	desc = "<Placeholder>"
	icon = 'modular_arkstation/modules/SAARE-Update/icons/saareflag.dmi'
