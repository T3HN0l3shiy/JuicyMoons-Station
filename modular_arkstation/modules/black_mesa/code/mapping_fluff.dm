...
/obj/structure/mineral_door/xen
	name = "organic door"
	color = "#ff8d58"
	icon = 'modular_arkstation/modules/black_mesa/icons/xen_door.dmi'
	icon_state = "resin"
	openSound = 'modular_arkstation/modules/black_mesa/sound/xen_door.ogg'
	closeSound = 'modular_arkstation/modules/black_mesa/sound/xen_door.ogg'
...
/obj/structure/pod
	...
	icon = 'modular_arkstation/modules/black_mesa/icons/structures.dmi'
	icon_state = "pod"
