...
/datum/action/cooldown/bloodsucker/targeted/tremere
	...
	button_icon = 'modular_arkstation/modules/bloodsucker/icons/mob/actions/tremere_bloodsucker.dmi'
	background_icon = 'modular_arkstation/modules/bloodsucker/icons/mob/actions/tremere_bloodsucker.dmi'
