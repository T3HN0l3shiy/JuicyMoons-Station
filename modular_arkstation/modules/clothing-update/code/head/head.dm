/obj/item/clothing/head/helmet/sec/metropolice
	...
	worn_icon_muzzled = 'modular_arkstation/modules/clothing-update/icons/mob/clothing/head/head_digi.dmi'
...
/obj/item/clothing/head/helmet/sec
	...
	unique_reskin = list(
		...
		"Blue Alt" = list(
			RESKIN_ICON = 'modular_arkstation/modules/clothing-update/icons/sec_reskins/obj/obj.dmi',
			RESKIN_WORN_ICON = 'modular_arkstation/modules/clothing-update/icons/sec_reskins/mob/mob.dmi',
...
/obj/item/clothing/head/hats/gwen_bow
	...
	icon_state = "gwen_bow"
	inhand_icon_state = null
	icon = 'modular_arkstation/modules/clothing-update/icons/gwen_clothes/obj/bow.dmi'
