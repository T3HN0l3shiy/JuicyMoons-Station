//sprites and helmes from Bubber
...
/obj/item/clothing/head/helmet/toggleable/pinwheel //sprites by Keila
	...
	icon = 'modular_arkstation/modules/clothing-update/icons/obj/clothing/head/hats.dmi'
	worn_icon = 'modular_arkstation/modules/clothing-update/icons/mob/clothing/head/hats.dmi'
	icon_state = "pinwheel"
...
/obj/item/clothing/head/playbunnyears
	...
	icon = 'modular_arkstation/modules/clothing-update/icons/obj/clothing/head/hats.dmi'
	worn_icon = 'modular_arkstation/modules/clothing-update/icons/mob/clothing/head/bunnyears.dmi'
