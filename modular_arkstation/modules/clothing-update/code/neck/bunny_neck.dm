...
/obj/item/clothing/neck/tie/bunnytie
	...
	icon = 'modular_arkstation/modules/clothing-update/icons/obj/clothing/neck/bunny_neck.dmi'
	worn_icon = 'modular_arkstation/modules/clothing-update/icons/mob/clothing/neck/bunny_neck.dmi'
