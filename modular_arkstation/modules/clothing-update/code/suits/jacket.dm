...
/obj/item/clothing/suit/jacket/tailcoat //parent type
	...
	worn_icon = 'modular_arkstation/modules/clothing-update/icons/mob/clothing/suits/jacket.dmi'
	worn_icon_digi = 'modular_arkstation/modules/clothing-update/icons/mob/clothing/suits/jacket_digi.dmi'
	icon = 'modular_arkstation/modules/clothing-update/icons/obj/clothing/suits/jacket.dmi'
	icon_state = "tailcoat"
