...
/obj/item/clothing/under/costume/playbunny
	...
	icon = 'modular_arkstation/modules/clothing-update/icons/obj/clothing/under/costume.dmi'
	worn_icon = 'modular_arkstation/modules/clothing-update/icons/mob/clothing/under/costume.dmi'
	worn_icon_digi = 'modular_arkstation/modules/clothing-update/icons/mob/clothing/under/costume_digi.dmi'
...
/obj/item/clothing/under/rank/security/security_bunnysuit
	...
	icon = 'modular_arkstation/modules/clothing-update/icons/obj/clothing/under/security.dmi'
	worn_icon = 'modular_arkstation/modules/clothing-update/icons/mob/clothing/under/security.dmi'
	body_parts_covered = CHEST|GROIN|LEGS
	alt_covers_chest = TRUE
