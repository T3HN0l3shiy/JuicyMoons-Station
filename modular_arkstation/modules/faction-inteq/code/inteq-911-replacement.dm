...
/obj/machinery/computer/communications/proc/call_911(ordered_team)
	...
	priority_announce(announcement_message, announcer, 'modular_arkstation/modules/faction-inteq/sound/inteq.ogg', has_important_message=TRUE, color_override = "orange")
...
/datum/antagonist/ert/request_911/greet()
	...
	greeted_mob.playsound_local(greeted_mob, 'modular_arkstation/modules/sounds-renewal/sound/antag/raiders.ogg', 100, FALSE, pressure_affected = FALSE, use_reverb = FALSE)
...
/obj/item/solfed_reporter/attack_self(mob/user, modifiers)
	...
	if(!activated && !GLOB.solfed_responder_info[type_of_callers][SOLFED_DECLARED])
		...
		if(current_votes >= amount_of_responders * 0.5)
			...
			priority_announce(announcement_message, announcement_source, 'modular_arkstation/modules/faction-inteq/sound/inteq.ogg', has_important_message = TRUE, color_override = "orange")
			var/list/candidates = SSpolling.poll_ghost_candidates(
				ghost_poll_msg,
				jobban_to_check,
				alert_pic = /obj/item/solfed_reporter,
...
/obj/effect/landmark/inteq_spawn
	name = "InteQteam"
	icon = 'modular_arkstation/modules/faction-inteq/icons/landmark.dmi'
