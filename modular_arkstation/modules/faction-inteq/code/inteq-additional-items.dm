...
/obj/item/radio/headset/inteq
	...
	icon = 'modular_arkstation/modules/faction-inteq/icons/ear_obj.dmi'
	radiosound = 'modular_arkstation/modules/sounds-renewal/sound/radio.ogg'
	freerange = FALSE
	freqlock = TRUE
...
/obj/item/encryptionkey/headset_syndicate/inteq
	...
	icon = 'modular_arkstation/modules/faction-inteq/icons/key.dmi'
