/obj/machinery/meter
	icon = 'modular_arkstation/modules/goon-icons-port/goon-atmos-meter.dmi'

/obj/structure/shipping_container/ntbox
	name = "container"
	desc = "Container with Nanotreisen identification marks."
	icon = 'modular_arkstation/modules/goon-icons-port/goon-crates.dmi'
	icon_state = "ntcrate1"
...
/obj/machinery/dna_scannernew
	icon = 'modular_arkstation/modules/goon-icons-port/goon-cryogenics.dmi'
	icon_state = "scanner"
	base_icon_state = "scanner"

/obj/item/healthanalyzer
	name = "health analyzer"
	icon = 'modular_arkstation/modules/goon-icons-port/goon-devices.dmi'
	icon_state = "health"
...
/obj/structure/big_structure
	...
	icon = 'modular_arkstation/modules/goon-icons-port/goon-golo.dmi'
...
/obj/item/bikehorn
	icon = 'modular_arkstation/modules/goon-icons-port/goon-instruments.dmi'
	icon_state = "bike_horn"

/obj/item/mop
	icon = 'modular_arkstation/modules/goon-icons-port/goon-janitor.dmi'
	icon_state = "mop"

/obj/item/station_charter
	icon = 'modular_arkstation/modules/goon-icons-port/goon-scrolls.dmi'
...
/obj/item/clothing/neck/stethoscope
	icon = 'modular_arkstation/modules/goon-icons-port/goon-stethoscope.dmi'
	icon_state = "stethoscope"

/obj/structure/generator_structure
	name = "generator"
	desc = "Massive generator. It is stoped."
	icon = 'modular_arkstation/modules/goon-icons-port/goon-turbine.dmi'
...
/obj/structure/train_carriage
	...
	icon = 'modular_arkstation/modules/goon-icons-port/goon-vagons_stoped.dmi'
...
/obj/structure/goon_computers
	...
	icon = 'modular_arkstation/modules/goon-icons-port/goon-computers.dmi'
