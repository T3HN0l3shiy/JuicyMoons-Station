...
/obj/item/radio/headset/headset_med/green
	icon = 'modular_arkstation/modules/green-medbay/icons/icons.dmi'

// BACKPACKS

/obj/item/storage/backpack/medic/green
	icon = 'modular_arkstation/modules/green-medbay/icons/clothing/backpacks_obj.dmi'
	worn_icon = 'modular_arkstation/modules/green-medbay/icons/clothing/backpacks_mob.dmi'
...
/obj/item/clothing/under/rank/medical/doctor/green
	...
	icon = 'modular_arkstation/modules/green-medbay/icons/clothing/obj.dmi'
	worn_icon = 'modular_arkstation/modules/green-medbay/icons/clothing/mob.dmi'
