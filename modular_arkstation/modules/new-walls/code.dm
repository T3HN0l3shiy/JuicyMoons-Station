...
/turf/closed/wall/old
	icon = 'modular_arkstation/modules/new-walls/walls.dmi'

/turf/closed/wall/r_wall/old
	icon = 'modular_arkstation/modules/new-walls/r_walls.dmi'
...
/turf/closed/wall/material/old
	icon = 'modular_arkstation/modules/new-walls/material_wall.dmi'
	icon_state = "wall-0"
	base_icon_state = "wall"
...
/obj/structure/falsewall/old
	icon = 'modular_arkstation/modules/new-walls/walls.dmi'
	fake_icon = 'modular_arkstation/modules/new-walls/walls.dmi'

/obj/structure/falsewall/reinforced/old
	name = "reinforced wall"
	desc = "A huge chunk of reinforced metal used to separate rooms."
	icon = 'modular_arkstation/modules/new-walls/r_walls.dmi'
	fake_icon = 'modular_arkstation/modules/new-walls/r_walls.dmi'

/obj/structure/falsewall/material/old
	icon = 'modular_arkstation/modules/new-walls/material_wall.dmi'
	icon_state = "wall-open"
	base_icon_state = "wall"
	fake_icon = 'modular_arkstation/modules/new-walls/material_wall.dmi'
