...
//
	...
	if(!HAS_TRAIT(user, TRAIT_MIMING))
		playsound(user, user.gender == MALE ? 'modular_arkstation/modules/now-we-can-jump/jump_male.ogg' : 'modular_arkstation/modules/now-we-can-jump/jump_female.ogg', 25, 0, 1)
