...
/obj/structure/closet/secure_closet/security_medic
	...
	// icon = 'modular_arkstation/modules/security-medic-renewal/icons/misc.dmi' // ПЕРЕЗАПИСАЛ ТУТ modular_arkstation\modules\new-closets\code.dm
	// icon_state = "brigdoc"														 // ПЕРЕЗАПИСАЛ ТУТ modular_arkstation\modules\new-closets\code.dm
