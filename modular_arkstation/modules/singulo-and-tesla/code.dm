...
/obj/machinery/the_singularitygen
	...
	icon = 'modular_arkstation/modules/singulo-and-tesla/sing_gen.dmi'
...
/obj/effect/accelerated_particle
	...
	icon = 'modular_arkstation/modules/singulo-and-tesla/particle_accelerator.dmi'
	icon_state = "particle"
	anchored = TRUE
	density = FALSE
...
/obj/machinery/particle_accelerator/control_box
	...
	icon = 'modular_arkstation/modules/singulo-and-tesla/particle_accelerator_controlbox.dmi'
	...
	if((last_shot + fire_delay) <= world.time)
		...
		switch(strength)
			if(0)
				...
				playsound(src, 'modular_arkstation/modules/singulo-and-tesla/cyclotron.ogg', 30, FALSE)
			if(1)
				P = new/obj/effect/accelerated_particle(T)
				playsound(src, 'modular_arkstation/modules/singulo-and-tesla/cyclotron.ogg', 70, FALSE)
			if(2)
				P = new/obj/effect/accelerated_particle/strong(T)
				playsound(src, 'modular_arkstation/modules/singulo-and-tesla/cyclotron.ogg', 100, FALSE)
			if(3)
...
/obj/effect/singularity_creation
	...
	icon = 'modular_arkstation/modules/singulo-and-tesla/singularity_creation.dmi'
	icon_state = ""
	anchored = TRUE
	opacity = FALSE
	pixel_x = -32
...
/obj/singularity
	icon = 'modular_arkstation/modules/singulo-and-tesla/singularity_s1.dmi'
	anchored = TRUE
	...
	switch(temp_allowed_size)
		...
		if(STAGE_TWO)
			if(check_cardinals_range(1, TRUE))
				...
				icon = 'modular_arkstation/modules/singulo-and-tesla/singularity_s3.dmi'
		...
		if(STAGE_THREE)
			if(check_cardinals_range(2, TRUE))
				...
				icon = 'modular_arkstation/modules/singulo-and-tesla/singularity_s5.dmi'
		...
		if(STAGE_FOUR)
			if(check_cardinals_range(3, TRUE))
				...
				icon = 'modular_arkstation/modules/singulo-and-tesla/singularity_s7.dmi'
		...
		if(STAGE_FIVE)//this one also lacks a check for gens because it eats everything
			...
			icon = 'modular_arkstation/modules/singulo-and-tesla/singularity_s9.dmi'
