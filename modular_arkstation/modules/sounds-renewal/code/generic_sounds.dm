...
/obj/item/gun/ballistic/shotgun
	fire_sound = 'modular_arkstation/modules/sounds-renewal/sound/weapons/gunshotshotgunshot.ogg'
	load_sound = 'modular_arkstation/modules/sounds-renewal/sound/weapons/shotguninsert.ogg'
	rack_sound = 'modular_arkstation/modules/sounds-renewal/sound/weapons/shotgun_pump.ogg'
...
/obj/item/gun/ballistic/revolver
	fire_sound = 'modular_arkstation/modules/sounds-renewal/sound/weapons/revolvershot.ogg'

/obj/item/gun/ballistic/automatic
	fire_sound = 'modular_arkstation/modules/sounds-renewal/sound/weapons/gunshot_smg_alt.ogg'

/obj/item/gun/ballistic/automatic/sol_smg
	fire_sound = 'modular_arkstation/modules/sounds-renewal/sound/weapons/gunshot_smg_alt.ogg'

/obj/item/gun/ballistic/automatic/l6_saw
	fire_sound = 'modular_arkstation/modules/sounds-renewal/sound/weapons/lmgshot.ogg'

/obj/item/ammo_casing/energy
	fire_sound = 'modular_arkstation/modules/sounds-renewal/sound/weapons/laser.ogg'
...
/obj/item/chainsaw/attack_self(mob/user)
	. = ..()
	if(on)
		playsound(src, 'modular_arkstation/modules/sounds-renewal/sound/weapons/chainsawstart.ogg', 65, 1)

	if(on)
		hitsound = 'modular_arkstation/modules/sounds-renewal/sound/weapons/chainsawhit.ogg'
		chainsaw_loop.start()
	else
...
/datum/centcom_announcer/default
	...
	event_sounds = list(
		...
		ANNOUNCER_KLAXON = 'modular_arkstation/modules/black_mesa/sound/siren1_long.ogg',
...
/obj/machinery/door/airlock
	doorDeni = 'modular_arkstation/modules/sounds-renewal/sound/machines/deniedbeep.ogg'

//////////////////// Зоны, эмбиенты

// /area
// 	ambient_buzz = 'modular_arkstation/modules/sounds-renewal/sound/ambience/shipambience.ogg'
...
/area/station/science
	ambient_buzz = 'modular_arkstation/modules/sounds-renewal/sound/ambience/sci.ogg'
	ambient_buzz_vol = 20
...
/area/station/medical
	ambient_buzz = 'modular_arkstation/modules/sounds-renewal/sound/ambience/med.ogg'
	ambient_buzz_vol = 20
...
/area/station/medical/surgery
	ambient_buzz = 'modular_arkstation/modules/sounds-renewal/sound/ambience/med_sur.ogg'
	ambient_buzz_vol = 20

// CHAPEL
/area/station/service/chapel
	ambient_buzz = 'modular_arkstation/modules/sounds-renewal/sound/ambience/church.ogg'
	ambient_buzz_vol = 25
	ambientsounds = list('modular_arkstation/modules/sounds-renewal/sound/ambience/church-bell1.ogg',
						'modular_arkstation/modules/sounds-renewal/sound/ambience/church-bell2.ogg',
						'modular_arkstation/modules/sounds-renewal/sound/ambience/church-cross1.ogg',
						'modular_arkstation/modules/sounds-renewal/sound/ambience/church-cross2.ogg',
...
/area/station/security
	ambient_buzz = 'modular_arkstation/modules/sounds-renewal/sound/ambience/ambidanger6.ogg'
	ambient_buzz_vol = 15
...
/area/shuttle/pirate/nri
	...
	ambientsounds = list('modular_nova/modules/encounters/sounds/alarm_radio.ogg',
						...
						'modular_nova/modules/encounters/sounds/gear_stop.ogg',
						'modular_nova/modules/encounters/sounds/intercom_loop.ogg',
						'modular_arkstation/modules/sounds-renewal/sound/ambience/radio/1.ogg',
						'modular_arkstation/modules/sounds-renewal/sound/ambience/radio/2.ogg',
						'modular_arkstation/modules/sounds-renewal/sound/ambience/radio/3.ogg',
						'modular_arkstation/modules/sounds-renewal/sound/ambience/radio/4.ogg',
						'modular_arkstation/modules/sounds-renewal/sound/ambience/radio/5.ogg',
						'modular_arkstation/modules/sounds-renewal/sound/ambience/radio/6.ogg',
						'modular_arkstation/modules/sounds-renewal/sound/ambience/radio/7.ogg',
						'modular_arkstation/modules/sounds-renewal/sound/ambience/radio/8.ogg',
						'modular_arkstation/modules/sounds-renewal/sound/ambience/radio/9.ogg')

/area/awaymission/beach
	forced_ambience = TRUE
	ambient_buzz = 'modular_arkstation/modules/sounds-renewal/sound/ambience/beach.ogg'
	ambient_buzz_vol = 25

/area/centcom/syndicate_mothership
	ambient_buzz = 'modular_arkstation/modules/sounds-renewal/sound/ambience/stadium.ogg'
	ambient_buzz_vol = 15
	min_ambience_cooldown = 15 SECONDS
	max_ambience_cooldown = 25 SECONDS
	ambientsounds = list('modular_nova/modules/encounters/sounds/alarm_radio.ogg',
