...
/obj/machinery/walltank
	...
	icon = 'modular_arkstation/modules/spacepods/icons/structures/spacegas_dolbajob.dmi'
	icon_state = "spacegas"
	anchored = TRUE
...
/obj/machinery/walltank/attack_hand(mob/living/user, list/modifiers)
	...
	current_beam = new(user, src, icon = 'modular_arkstation/modules/spacepods/icons/structures/beam.dmi', icon_state = "hose", beam_type = /obj/effect/ebeam/fuel_hose)
