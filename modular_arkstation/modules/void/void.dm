...
/turf/open/indestructible/void
	icon = 'modular_arkstation/modules/goon-icons-port/goon-void.dmi'
	icon_state = "void"
	name = "VOID"
	desc = "VOID"
...
/obj/effect/particle_effect/sparks/void_fissure/LateInitialize()
	...
	playsound(src, 'modular_arkstation/modules/void/sound.ogg', 30, TRUE, SHORT_RANGE_SOUND_EXTRARANGE, use_reverb = TRUE)
	QDEL_IN(src, 30)
...
/obj/effect/step_trigger/void/proc/activate_void(mob/living/carbon/triggerer)
	...
	if(!istype(triggerer, /mob/living/basic/void_monster) && prob(6))
		var/sound/sound = sound('modular_arkstation/modules/void/trip_blast.wav')
...
/area/centcom/void
	...
	name = "void"
	ambient_buzz = 'modular_arkstation/modules/void/void.ogg'
	ambient_buzz_vol = 30
...
/atom/movable/screen/fullscreen/screamers
	icon = 'modular_arkstation/modules/void/screamers.dmi'
...
/mob/living/basic/void_monster
	...
	icon = 'modular_arkstation/modules/void/babaika.dmi'
	icon_state = "babaika"
	health = 200000
	maxHealth = 200000
