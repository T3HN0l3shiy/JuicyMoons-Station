/proc/get_sfx_nova(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("explosion")
				soundin = pick(
					'modular_arkstation/modules/black_mesa/sound/explosions/explode1.ogg', // ARK STATION EDIT
					'modular_arkstation/modules/black_mesa/sound/explosions/explode2.ogg', // ARK STATION EDIT
					'modular_arkstation/modules/black_mesa/sound/explosions/explode3.ogg', // ARK STATION EDIT
					'modular_arkstation/modules/black_mesa/sound/explosions/explode4.ogg', // ARK STATION EDIT
					'modular_arkstation/modules/black_mesa/sound/explosions/explode5.ogg', // ARK STATION EDIT
					'modular_arkstation/modules/black_mesa/sound/explosions/explode6.ogg', // ARK STATION EDIT
					'modular_arkstation/modules/black_mesa/sound/explosions/explode7.ogg', // ARK STATION EDIT
				)
			if(SFX_BRICK_DROP)
				soundin = pick(
