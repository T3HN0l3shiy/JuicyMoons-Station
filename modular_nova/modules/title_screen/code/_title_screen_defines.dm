...
#define DEFAULT_TITLE_SCREEN_IMAGE 'modular_arkstation/_master_files/icons/ui_icons/theme/screen.jpg' // ARK STATION EDIT
#define DEFAULT_TITLE_LOADING_SCREEN 'modular_arkstation/_master_files/icons/ui_icons/theme/loading.gif' // ARK STATION EDIT
